...
void sf_push(stack_t **head, unsigned int number);
void sf_pall(stack_t **head, unsigned int number);
void sf_pint(stack_t **head, unsigned int number);
...
void sf_nop(stack_t **head, unsigned int counter);
...
void sf_rotl(stack_t **head, unsigned int counter);
void sf_rotr(stack_t **head, __attribute__((unused)) unsigned int counter);
void addnode(stack_t **head, int n);
void addqueue(stack_t **head, int n);
void sf_queue(stack_t **head, unsigned int counter);
void sf_stack(stack_t **head, unsigned int counter);
#endif
